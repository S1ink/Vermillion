...
struct ImVector
{
    ...
    inline T&           operator[](int i)                   { /*IM_ASSERT(i >= 0 && i < Size);*/IM_ASSERT(i >= 0); IM_ASSERT(i < Size); return Data[i]; }
    inline const T&     operator[](int i) const             { /*IM_ASSERT(i >= 0 && i < Size);*/IM_ASSERT(i >= 0); IM_ASSERT(i < Size); return Data[i]; }
